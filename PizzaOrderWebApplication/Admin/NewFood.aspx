                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Button runat="server" Text="Delete" CommandName="DeletePizza"
                                    OnClientClick="return confirm('Bạn có muốn xóa hay không?');"
                                    CommandArgument='<%# Eval("FoodID") %>' CssClass="btn-danger btn btn-sm" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
